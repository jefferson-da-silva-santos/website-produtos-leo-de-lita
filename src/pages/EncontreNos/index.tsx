    ...
    <div className="group-encontre-nos" id="encontre-nos">
        ...
        <section className="group-encontre-nos__econtre-nos">
          <div className="group-encontre-nos__econtre-nos__group-primary" data-aos="fade-left">
            ...
            <p className="group-encontre-nos__econtre-nos__group-primary__text">
              A Empresa Produtos Leo de Lita está localizada na cidade de
              Jaboatão dos Guararapes, oferecendo bolachas artesanais de
              altíssima qualidade, feitas com carinho e ingredientes
